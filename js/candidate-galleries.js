...
const candidateGalleryData = {
  "macak.html": {
    ...
    "photos": [
      ...
      "DSC_6943.jpg",
      "DSC_6950.jpg",
      "IMG_20180925_185309.jpg",
      "IMG_20220324_184009.jpg",
      "LJM_8583 o.jpg"
    ]
  },
  "hana-janickova.html": {
  ...
  "jan-gronych.html": {
    "folder": "Jan Gronych",
    "photos": [
      "7e27ef76-1371-40a3-b0a6-f35f33e8cb5e.jpeg",
      "b5009560-5633-49b4-a9b0-84930884bc16.jpeg",
      "DSC_6739.jpg",
      "DSC_6860.jpg",
      "DSC_6939.jpg",
      "DSC_6940.jpg"
  ...
  "janku.html": {
    ...
    "photos": [
      ...
      "DSC_6998.jpg",
      "DSC_7138 (1).jpg",
      "PHOTO-2023-12-26-14-21-34.jpeg"
    ]
  },
  "stanislav-jelinek.html": {
    ...
    "photos": [
      ...
      "20260426_103738.jpg",
      "519618226_24389959810600418_3649341866152367495_n.jpg",
      "DSC_6682.jpg",
      "DSC_6843.jpg",
      "DSC_6845.jpg",
      "DSC_6858.jpg",
...
if (candidateGallery?.photos.length) {
  ...
  candidateMain.insertAdjacentHTML("beforeend", `
    <section class="candidate-gallery-section" aria-label="Fotografie kandidáta">
      <div class="section-shell">
        <div class="gallery" data-gallery tabindex="0">
          <div class="gallery-stage">
            <img class="gallery-main-image" src="${photoPath(candidateGallery.photos[0])}" alt="Fotografie ${candidateName}" data-gallery-main>
            <button class="gallery-arrow gallery-prev" type="button" aria-label="Předchozí fotografie" data-gallery-prev>‹</button>
            <button class="gallery-arrow gallery-next" type="button" aria-label="Následující fotografie" data-gallery-next>›</button>
            <span class="gallery-counter" aria-live="polite" data-gallery-counter>1 / ${candidateGallery.photos.length}</span>
          </div>
          <div class="gallery-thumbnails" aria-label="Náhledy fotografií">
            ${thumbnails}
          </div>
        </div>
      </div>
